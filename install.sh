...
apt-get install git curl ca-certificates libglib2.0-0 libsm6 libxext6 libxrender-dev ffmpeg cifs-utils -y > /dev/null 2>&1   # ffmpeg e cifs-utils: registrazioni NVR su USB / cartelle di rete
